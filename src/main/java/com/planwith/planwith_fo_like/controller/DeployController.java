package com.planwith.planwith_fo_like.controller;
...
import com.planwith.planwith_fo_like.dto.LoginRequest;
import com.planwith.planwith_fo_like.dto.LoginResponse;
import com.planwith.planwith_fo_like.service.AuthService;
...
@Validated
@RestController
@RequestMapping("/api/planwith-fo-like")
@Tag(name = "planwith-fo-like", description = "Server notebook deploy verification API")
public class DeployController {
	...
	public ResponseEntity<Map<String, String>> deployCheck() {
		return ResponseEntity.ok(Map.of(
				"service", "planwith-fo-like",
				"marker", deployProperties.marker(),
				"message", "planwith-fo-like deploy pipeline ok"
		));
	}
